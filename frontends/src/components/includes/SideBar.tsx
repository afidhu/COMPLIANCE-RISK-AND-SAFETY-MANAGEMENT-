            ...
            <div className="sidebar" data-background-color="dark">
                <div className="sidebar-logo">
                    ...
                    <div className="logo-header" data-background-color="dark">
                        ...
                        <Link   to={user.role ==="ESTATE_MANAGER"?'/dashboard' :user.role ==="INSPECTOR"?'/DashboardAnalysis':"#"} className="logo">
                        ...
                        {user.role !='STAFF_MEMBER' && ( */}
                            ...
                            <li className="nav-item">
                                ...
                                <div className="collapse" id="assetCompliance">
                                    <ul className="nav nav-collapse">
                                        <li>
                                            <Link to={user.role ==="ESTATE_MANAGER" ||user.role === "INSPECTOR"?'/assets':"#"}>
                                                <span className="sub-item">Assets</span>
                                            </Link>
                                        </li>
                                        <li>
                                            <Link to={user.role ==="ESTATE_MANAGER" ||user.role === "INSPECTOR"?'/Compliance':"#"}>
                            ...
                            <li className="nav-item">
                                ...
                                <div className="collapse" id="HazardIncident">
                                    <ul className="nav nav-collapse">
                                        <li>
                                            <Link to={user.role ==="ESTATE_MANAGER" ||user.role === "INSPECTOR"?'/Hazards':"#"}>
                                                <span className="sub-item">Hazard</span>
                                            </Link>
                                        </li>
                                        <li>
                                            <Link to={user.role ==="ESTATE_MANAGER" ||user.role === "INSPECTOR"?'/Incidents':"#"}>
                            ...
                            <li className="nav-item">
                                ...
                                <div className="collapse" id="MitigationsRisks">
                                    <ul className="nav nav-collapse">
                                        <li>
                                            <Link to={user.role ==="ESTATE_MANAGER" ||user.role === "INSPECTOR"?'/risks':"#"}>
                            ...
                            <li className="nav-item">
                                ...
                                <div className="collapse" id="sidebarLayouts">
                                    <ul className="nav nav-collapse">
                                        <li>
                                            <Link to={user.role ==="ESTATE_MANAGER" ||user.role === "INSPECTOR"?'/RisksReport':"#"} >
                                                <span className="sub-item">RisksReport</span>
                                            </Link>
                                        </li>
                                        <li>
                                            <Link to={user.role ==="ESTATE_MANAGER" ||user.role === "SAFETY_OFFICER"?'/IncidentsReport':"#"}>
                                                <span className="sub-item">IncidentsReport</span>
                                            </Link>
                                        </li>
                                        <li>
                                            <Link to={user.role ==="ESTATE_MANAGER" ||user.role === "INSPECTOR"?'/AssetsReport':"#"}>
                            ...
                            <li className="nav-item">
                                ...
                                <div className="collapse" id="accounts">
                                    <ul className="nav nav-collapse">
                                        <li>
                                            <Link to={user.role ==="ESTATE_MANAGER"?'/AllUsers':"#"}>
                            ...
                            <li className="nav-item">
                                ...
                                <div className="collapse" id="notifications">
                                    <ul className="nav nav-collapse">
                                        <li>
                                            <Link to={user.role ==="ESTATE_MANAGER"?'/Notifications':"#"}>
