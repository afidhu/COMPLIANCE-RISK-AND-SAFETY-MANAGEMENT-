...
const ColorScheme lightColorScheme = ColorScheme(
  ...
  primaryFixed: Color(0xFFBFBFF9),
  primaryFixedDim: Color(0xFF8C8CEC),
  onPrimaryFixed: Color(0xFF00003E),
  onPrimaryFixedVariant: Color(0xFF000051),
  secondary: Color(0xFF66FFF9),
  onSecondary: Color(0xFF000000),
  secondaryContainer: Color(0xFFC8F9F7),
  onSecondaryContainer: Color(0xFF000000),
  secondaryFixed: Color(0xFFC1F3F1),
  secondaryFixedDim: Color(0xFF9DECE9),
  onSecondaryFixed: Color(0xFF002927),
  onSecondaryFixedVariant: Color(0xFF005C58),
  tertiary: Color(0xFF018786),
  onTertiary: Color(0xFFFFFFFF),
  tertiaryContainer: Color(0xFFB3F1F0),
  onTertiaryContainer: Color(0xFF000000),
  tertiaryFixed: Color(0xFFC0EEEE),
  tertiaryFixedDim: Color(0xFF8DDBDB),
  onTertiaryFixed: Color(0xFF001B1B),
  onTertiaryFixedVariant: Color(0xFF002D2D),
