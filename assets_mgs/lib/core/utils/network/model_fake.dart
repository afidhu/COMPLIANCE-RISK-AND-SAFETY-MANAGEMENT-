...
class PharmacyEntity extends Equatable {
  ...
  const PharmacyEntity({
    ...
    required this.pharmaAddress,
    required this.pharmaLocation,
    required this.pharmaPhone,
    required this.pharmaEmail,
    required this.pharmaPassword,
    required this.pharmaConfirmPassword,
    required this.pharmaLicense,
    required this.pharmaOpenTime,
    required this.pharmaCloseTime,
    required this.pharmaImage,
